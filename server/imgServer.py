...
global S_addr_port
S_addr_port=("172.16.10.227", 12345)
...
def RT_Image(object, client, D_addr):
    if (check_option(object, client) == 0):
        return
    camera = cv2.VideoCapture(-1)  # 从摄像头中获取视频
