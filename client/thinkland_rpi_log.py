...
class LogRecordSocketReceiver(socketserver.ThreadingTCPServer):
    ...
    def __init__(self, host='localhost',
        ...
        global g_logPort
        socketserver.ThreadingTCPServer.__init__(self, (g_logPort, port), handler)
        self.abort = 0
        self.timeout = 1
        self.logname = None
...
def logServer():
    #logging.basicConfig(filename='.//server.log',format='%(relativeCreated)5d %(name)-15s %(levelname)-8s %(message)s')
